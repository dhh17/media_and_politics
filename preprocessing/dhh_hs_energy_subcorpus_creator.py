...
Helsingin Sanomat energy subcorpus creator.

Creates a Helsingin Sanomat energy subcorpus from the article IDs queried through the Octavo API matching to the
wanted lemmas.
...
def main():
    ...
    energy_files = ['energy-hs-subcorpus-ids.txt']
    destination = ""
    source = ""
    ...
    for energy_file in energy_files:
        ...
        for file_id in file_ids:
            destination = "/dhh17/hs_energy_subcorpus/" + file_id + ".analysis.json"
